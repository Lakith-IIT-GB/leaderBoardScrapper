...
class HackerrankLeaderboard:
    ...
    def combine_excel_sheets(self):
        ...
        messagebox.showinfo(
            ...
            "1. First, upload the Student Excel sheet\n"
            "   Option A: File with 'Roll number' and 'Hackerrank' columns\n"
            "   Option B: File with just 'Hackerrank' usernames (auto-generates User_001, User_002, etc.)\n"
            "   Option C: File with usernames in first column (any name)\n\n"
